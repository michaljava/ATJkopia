 ...
 * generated in the atj.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _Add_QNAME = new QName("http://ws.atj/", "add");
    private final static QName _AddResponse_QNAME = new QName("http://ws.atj/", "addResponse");
    private final static QName _Div_QNAME = new QName("http://ws.atj/", "div");
    private final static QName _DivResponse_QNAME = new QName("http://ws.atj/", "divResponse");
    private final static QName _Mul_QNAME = new QName("http://ws.atj/", "mul");
    private final static QName _MulResponse_QNAME = new QName("http://ws.atj/", "mulResponse");
    private final static QName _Sub_QNAME = new QName("http://ws.atj/", "sub");
    private final static QName _SubResponse_QNAME = new QName("http://ws.atj/", "subResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: atj.ws
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://ws.atj/", name = "add")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.atj/", name = "addResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.atj/", name = "div")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.atj/", name = "divResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.atj/", name = "mul")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.atj/", name = "mulResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.atj/", name = "sub")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.atj/", name = "subResponse")
