...
public class ObjectFactory {
    ...
    private final static QName _UploadFile_QNAME = new QName("http://ws.atj/", "uploadFile");
    private final static QName _UploadFileResponse_QNAME = new QName("http://ws.atj/", "uploadFileResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://ws.atj/", name = "uploadFile")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.atj/", name = "uploadFileResponse")
